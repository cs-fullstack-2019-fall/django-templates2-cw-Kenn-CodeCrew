...
def index(request):
    ...
    return render(request, "movieAp/movies.html", context)
...
def movie_details(request, movieID):
    ...
    return render(request, "movieAp/movie_details.html", context)

def movie_synopsis(request, movieID):
    context = {
        "movie": movies[movieID],
    }
    return render(request, "movieAp/movie_synopsis.html", context)
